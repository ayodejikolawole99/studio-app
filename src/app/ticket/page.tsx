...
function TicketPageContent() {
  ...
  if (ticketParam) {
    try {
      ...
      const decoded = decodeURIComponent(ticketParam);
      ...
      ticket = null; // fallback gracefully
    }
  }
  ...
  return (
    <>
      <div className="fixed inset-0 -z-10 bg-background/50 no-print"></div>
      <div
        className="fixed inset-0 -z-20 bg-contain bg-no-repeat bg-center opacity-10 no-print"
        style={{
          backgroundImage:
            "url('https://upload.wikimedia.org/wikipedia/commons/3/3d/Graphic_Packaging_International_Logo.jpg')",
        }}
      ></div>
      <main className="min-h-screen flex items-center justify-center bg-transparent p-4 print:bg-white print:min-h-0 print:p-0 print-container">
